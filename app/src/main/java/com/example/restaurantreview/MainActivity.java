...
public class MainActivity extends AppCompatActivity {
    ...
    //private static final String RESTAURANT_ID = "w9pga3s2tubkfw1e867";
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = ApiConfig.getApiService().postReview(RESTAURANT_ID, "My Self", review);
